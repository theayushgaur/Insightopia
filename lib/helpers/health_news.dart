...
class HealthNews {
  ...
  Future<void> getHealthNews() async {
    ...
    final response = await http.get(Uri.parse(
        ...
        "https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=34bc6a6124394808bc47019dcee90388"));
    ...
    if (data['status'] == "ok") {
      data["articles"].forEach((element) {
        if (element["urlToImage"] != null &&
          ...
          healthnews.add(articleModel); //added the data to the list we made
        }
      });
    }
  }
