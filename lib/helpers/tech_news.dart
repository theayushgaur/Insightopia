...
class TechNews {
  ...
  Future<void> getTechNews() async {
    ...
    final response = await http.get(Uri.parse(
        ...
        "https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=34bc6a6124394808bc47019dcee90388"));
    ...
    if (data['status'] == "ok") {
      data["articles"].forEach((element) {
        if (element["urlToImage"] != null &&
          ...
          technews.add(articleModel); //added the data to the list we made
        }
      });
    }
  }
